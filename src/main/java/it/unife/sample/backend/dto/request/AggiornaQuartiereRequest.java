...
// rappresenta la richiesta per aggiornare un quartiere esistente, contiene il nome del quartiere e la città in cui si trova
@Data // genera automaticamente i metodi getter, setter, equals, hashCode e toString per i campi della classe
public class AggiornaQuartiereRequest {
